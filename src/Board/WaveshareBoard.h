 ...
 */
// PIEGE : le premier champ (taskStackSize) n'est PAS celui qui dimensionne la
// pile de la tache mqtt sur ce profil. MQTTModule::taskStackSize() rend une
// valeur en dur sous #if defined(FLOW_PROFILE_WAVESHARE) et ne lit
// Limits::Mqtt::TaskStackSize -- donc ce champ -- que dans sa branche #else.
// Le modifier seul ne change rien : erreur commise le 2026-08-20.
// Il est aligne sur 7680 pour rester coherent si le #if disparaissait un jour,
// mais la valeur qui compte est dans MQTTModule.h.
