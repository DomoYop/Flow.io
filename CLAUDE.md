...
- **Marge flash faible** : l'image Waveshare-ESP32-S3 occupe ~93 % de sa partition applicative. Toute nouvelle page web, driver IO ou extension MQTT/OTA doit être pesée. Privilégier le code sobre et vérifier la taille binaire après ajout.
