...
constexpr char IO_IN8EN[] = "io_in8en"; // IO module persisted key for field `io_ina228_enabled`.
constexpr char IO_IN8AD[] = "io_in8ad"; // IO module persisted key for field `io_ina228_address`.
constexpr char IO_IN8PL[] = "io_in8pl"; // IO module persisted key for field `io_ina228_poll_ms`.
constexpr char IO_IN8SH[] = "io_in8sh"; // IO module persisted key for field `io_ina228_shunt_ohms`.
