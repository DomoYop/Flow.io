...
constexpr char DisAutoMode[] = "pl_disa"; // Desinfection : mode auto de la regulation.
...
constexpr char PoolVolumeM3[] = "pl_vol"; // Volume du bassin (m3) : filtration (turnover) et doses O2.
...
constexpr char PumpFlowM3h[] = "pl_pflw"; // Pool logic pump flow rate in m3/h (turnover-based filtration).
constexpr char FiltrWin1Enabled[] = "pl_fw1e"; // Filtration window 1 enable.
constexpr char FiltrWin1Start[] = "pl_fw1s"; // Filtration window 1 start (minutes from midnight).
constexpr char FiltrWin1Stop[] = "pl_fw1p"; // Filtration window 1 stop (minutes from midnight).
constexpr char FiltrWin1Priority[] = "pl_fw1r"; // Filtration window 1 fill priority (1 = first).
constexpr char FiltrWin2Enabled[] = "pl_fw2e"; // Filtration window 2 enable.
constexpr char FiltrWin2Start[] = "pl_fw2s"; // Filtration window 2 start (minutes from midnight).
constexpr char FiltrWin2Stop[] = "pl_fw2p"; // Filtration window 2 stop (minutes from midnight).
constexpr char FiltrWin2Priority[] = "pl_fw2r"; // Filtration window 2 fill priority.
constexpr char FiltrWin3Enabled[] = "pl_fw3e"; // Filtration window 3 enable.
...
constexpr char SensorHoldRefAge[] = "pl_shrfa"; // Age (s) vise pour la valeur figee : la reference est permutee a cet intervalle.
