...
constexpr char IO_TCAAL[] = "io_tcaal"; // IO module persisted key for field `io_tca9554_active_low`.
constexpr char IO_TCAEN[] = "io_tcaen"; // IO module persisted key for field `io_tca9554_enabled`.
constexpr char IO_TCAMK[] = "io_tcamk"; // IO module persisted key for field `io_tca9554_mask_default`.
